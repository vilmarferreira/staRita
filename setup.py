...
setup(
    name='staRita',
    version='',
    packages=['venv.Lib.site-packages.pytz', 'venv.Lib.site-packages.django', 'venv.Lib.site-packages.django.db',
              ...
              'venv.Lib.site-packages.django.templatetags', 'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip',
              ...
              'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip.operations', 'sta_rita.core', 'sta_rita.core.migrations',
              'sta_rita.eventos', 'sta_rita.eventos.migrations', 'sta_rita.sta_rita', 'sta_rita.categorias',
              'sta_rita.categorias.migrations'],
    url='',
    license='',
    author='VILMAR',
    author_email='',
